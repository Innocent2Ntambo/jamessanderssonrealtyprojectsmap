...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:32736',
            //extent: [576681.000000, 8456714.563325, 586724.604395, 8496038.810000],
            units: 'm'
        })
    })
});
...
map.getView().fit([576681.000000, 8456714.563325, 586724.604395, 8496038.810000], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">JAMES SANDERSSON REALTY CONSULTANTS PROJECT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (80 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Interactive web map showing the properties and status of the company\'s projects.';
            }
